...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['upload_project'])) {
    ...
    if (!empty($_FILES["images"]["tmp_name"][0])) {
        ...
        if (!empty($uploaded_images)) {
            ...
            $stmt = $conn->prepare("INSERT INTO ongoing_projects (image_url, client_name, area, location) VALUES (?, ?, ?, ?)");
...
$query = "SELECT * FROM ongoing_projects ORDER BY created_at DESC";
...
<a href="admin_dashboard.php" class="back-button">⬅ Back</a>
    ...
    <h2 class="text-center fade-in">Upload Ongoing Project</h2>
    ...
    <h2 class="mt-5 text-center fade-in">Ongoing Projects</h2>
